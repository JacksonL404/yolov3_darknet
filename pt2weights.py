...
checkpoint = torch.load("weights/best.pt", map_location='cpu')  # 导入训练好的.pt文件 改成自己的.pt文件地址
model.load_state_dict(checkpoint['model'])
save_weights(model, path='weights/flytest1080_0707.weights', cutoff=-1)  # 生成.weights文件 改成自己的地址
